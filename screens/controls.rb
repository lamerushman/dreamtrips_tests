...
class Controls < CommonScreen

  SCREEN_TITLE_LOCATOR = { name: 'Controls' }
  STANDARD_SWITCH_LOCATOR = { id: 'StandardSwitch' }
  STANDARD_SLIDER_LOCATOR = { id: 'StandardSlider' }
  CUSTOM_SLIDER_LOCATOR = { id: 'CustomSlider' }
  SCREEN_INDICATOR_TEXT_LOCATOR = { name: 'UIPageControl' }
  SCREEN_INDICATOR_LOCATOR = { class_name: 'UIAPageIndicator' }
...
# assert elements are displayed
  ...
  def ui_elements_mid
    yield SCREEN_INDICATOR_LOCATOR
...
# navigate screen
  ...
  def scroll_to_mid
    scroll_to SCREEN_INDICATOR_TEXT_LOCATOR
  end
